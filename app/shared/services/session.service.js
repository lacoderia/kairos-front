(function(angular) {
    ...
    angular.module('kairos').factory('sessionService', ['$http', '$rootScope', 'localStorageService', function ($http, $rootScope, localStorageService) {
        ...
        var getHttpHeaders = function(){
            return _headers || localStorageService.cookie.get('kairos-headers');
        };
        ...
        var setHttpHeaders = function(headers){
            localStorageService.cookie.set('kairos-headers', headers);
            _headers = headers;
            configHttpHeaders(headers);
        };

        var unsetHttpHeaders = function(){
            localStorageService.cookie.remove('kairos-headers');
            _headers = undefined;
